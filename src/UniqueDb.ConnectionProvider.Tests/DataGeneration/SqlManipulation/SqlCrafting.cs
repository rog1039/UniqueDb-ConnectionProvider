...
public class SqlCrafting
{
   ...
   {
      var index1 = InformationSchemaMetadataExplorer.GetIndexColumnDtos(TestSqlTables.Order_Head);
   ...
   {
      var index1 = InformationSchemaMetadataExplorer.GetTableConstraints(TestSqlTables.Order_Head);
      index1.PrintStringTable();
   ...
   {
      var index1 = InformationSchemaMetadataExplorer.GetForeignKeyColumnDtos(TestSqlTables.JobActivity);
      index1.PrintStringTable();
      InformationSchemaMetadataExplorer.GetTableConstraints(TestSqlTables.JobActivity).PrintStringTable();
   }
   ...
   public async Task SchemaExploration()
   {
      ...
      var columns      = InformationSchemaMetadataExplorer.GetInformationSchemaColumns(sqlTableRef);
      var isTable      = InformationSchemaMetadataExplorer.GetInformationSchemaTable(sqlTableRef);
      var tableDef     = InformationSchemaMetadataExplorer.GetInformationSchemaTableDefinition(sqlTableRef);
      var constraints  = InformationSchemaMetadataExplorer.GetTableConstraints(sqlTableRef);
      var indexColumns = InformationSchemaMetadataExplorer.GetIndexColumnDtos(sqlTableRef);
