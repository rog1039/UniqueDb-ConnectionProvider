...
using Woeber.Logistics.Infrastructure.Hashing;
...
namespace UniqueDb.ConnectionProvider.Tracing
{
    public class QueryExecutionPersistence
    {
        ...
        private SqlClientListener? _listener;
        private bool               _shouldProcessRecords;

        private string WindowsUserName    = Environment.UserName;
        ...
        public void Start()
        {
            ...
            _listener             = new SqlClientListener();
        ...
        public void Persist(QueryExecutionRecord record)
        {
            try
            {
                var insertRecord = new SqlExecutionTiming(record)
                {
    ...
    public class SqlExecutionTiming
    {
        ...
        public SqlExecutionTiming(QueryExecutionRecord record)
        {
    ...
    public class SqlClientListener : EventListener
    {
        ...
        /// </summary>
        private BlockingCollection<EventDataRecord> IncomingQueryRecords = new(500);
        ...
        public SqlClientListener(bool shouldAutoStart = true)
        {
...
9/29/2021 9:25:09 PM -  -  - message -TdsParserStateObject.DecrementOpenResultCount | INFO | State Object Id 1, Processing Attention.
        ...
        protected virtual void OnNewQueryExecutionRecord(QueryExecutionRecord obj)
        {
